...
export const GameStorage = {
  ...
  get localStorageKey() {
    return DEV ? "aprilDimensionTestSave" : "aprilDimensionSave";
  },

  backupDataKey(saveSlot, backupSlot) {
    return DEV ? `aprilBackupTestSave-${saveSlot}-${backupSlot}` : `aprilBackupSave-${saveSlot}-${backupSlot}`;
  },

  backupTimeKey(saveSlot) {
    return DEV ? `aprilBackupTestTimes-${saveSlot}` : `aprilBackupTimes-${saveSlot}`;
  },
