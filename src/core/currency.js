...
export class Currency {
  ...
  subtract(amount, safe = false) {
    if (safe) {
      this.value = this.operations.subtract(this.value, amount);
      return;
    }
  ...
  abs(){
    return this.operations.abs(this.value)
  }
...
Currency.antimatter = new (class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisInfinity.minAM = player.records.thisInfinity.minAM.min(value)
